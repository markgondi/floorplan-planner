...
export const FURNITURE_PRESETS: FurniturePreset[] = [
  { id: "wall", label: "Wall", kind: "wall", width: 200, depth: 10, color: "#4a453b" },
  { id: "door", label: "Door", kind: "door", width: 90, depth: 5, color: "#8a7c62" },
  { id: "access-reader", label: "Access Reader", kind: "reader", width: 10, depth: 10, color: "#b3593a" },
